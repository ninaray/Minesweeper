...
class HardViewController: UIViewController {
    ...
    @IBOutlet weak var hardBoard: UIView!
    ...
    func createBoard() {
        for row in 0 ... minesweeperboard.size-1 {
            for column in 0 ... minesweeperboard.size-1 {
                ...
                let squareButtonDim: CGFloat = self.hardBoard.frame.width/CGFloat(boarddim)
                ...
                self.hardBoard.addSubview(addSquareButton)
